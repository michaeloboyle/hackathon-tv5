...
output "cloudsql_replica_private_ip" {
  description = "Cloud SQL replica private IP address"
...
output "connection_info" {
  ...
  value = {
    ...
    database = {
      ...
      replica = {
        host = module.cloudsql.replica_private_ip_address
        port = 5432
      }
    }
    redis = {
      ...
      read_endpoint = {
        host = module.memorystore.read_endpoint
        port = module.memorystore.read_endpoint_port
      }
    }
  }
  sensitive = true
